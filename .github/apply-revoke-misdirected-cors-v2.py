...
(ROOT / 'tests' / 'misdirected_domain_cors.test.js').write_text("""'use strict';
...
anchor = "    { name: '56. SEO Indexing, Canonical Metadata & 404 Hardening', file: 'seo_indexing_metadata.test.js' }\n];"
replacement = "    { name: '56. SEO Indexing, Canonical Metadata & 404 Hardening', file: 'seo_indexing_metadata.test.js' },\n    { name: '57. Misdirected Custom-Domain CORS Revocation Guard', file: 'misdirected_domain_cors.test.js' }\n];"
...
print('Current-main stale custom-domain CORS revocation patch applied.')
