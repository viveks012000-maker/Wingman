...
async function runTests() {
    ...
    try {
        ...
        const res1 = await makeRequest(testServer, '/api/analyze', { images: sixImages });
        ...
        const res2 = await makeRequest(testServer, '/api/analyze', remoteImagePayload);
        ...
        const res3 = await makeRequest(testServer, '/api/analyze', { images: [oversizedSingleImage] });
        ...
        const res4 = await makeRequest(testServer, '/api/analyze', corruptPayload);
        ...
        const res5 = await makeRequest(testServer, '/api/analyze', { images: [unsupportedMime] });
        ...
        const res6 = await makeRequest(testServer, '/api/analyze', { imageBase64: legacySingle });
