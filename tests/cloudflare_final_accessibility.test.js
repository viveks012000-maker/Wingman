...
const creditNoticeRule=css.match(/body\.app-page #chatbox-credit-notice\s*\{([\s\S]*?)\}/);
assert.ok(creditNoticeRule && creditNoticeRule[1].includes('color: #c084fc'), 'Maeve credit notice must use the accessible purple');
