...
assert.strictEqual(serverFile.includes("if (authDelErr) {") && serverFile.includes("code: 'ACCOUNT_DELETE_FAILED'") && serverFile.includes('Unable to delete the account at this time.'), true, 'delete-account fails safe with a sanitized client message and stable code');
