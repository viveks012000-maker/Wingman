...
assert.ok(!buildSource.includes("default-src 'self' https://*.supabase.co https://static.cloudflareinsights.com"), 'Cloudflare Pages Insights must not broaden default-src');
