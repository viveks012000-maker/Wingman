...
assert(index.includes('<link rel="canonical" href="https://mywingmanapp.com/" />'), 'Landing canonical must use the verified custom production host.');
assert(index.includes('property="og:type" content="website"'), 'Landing must expose Open Graph type.');
assert(index.includes('property="og:url" content="https://mywingmanapp.com/"'), 'Open Graph URL must match canonical production host.');
assert(index.includes('property="og:image" content="https://mywingmanapp.com/logo-384.webp"'), 'Open Graph image must be absolute and production-hosted.');
...
assert(index.includes('name="twitter:image" content="https://mywingmanapp.com/logo-384.webp"'), 'Twitter image must be absolute and production-hosted.');
...
assert(robots.includes('Sitemap: https://mywingmanapp.com/sitemap.xml'), 'robots.txt must reference the verified production sitemap.');
...
for (const expected of [
  ...
  'https://mywingmanapp.com/privacy.html',
  'https://mywingmanapp.com/terms.html',
  'https://mywingmanapp.com/refund.html'
